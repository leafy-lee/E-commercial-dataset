...
_C.MODEL.FINETUNE = '/mnt/disk10T/liyifei/CVPR2022EC/output/sal+ocr/swin_tiny_patch4_window7_224/default/ckpt_epoch_49.pth'
...
def update_config(config, args):
    ...
    if args.datanum:
        config.DATA.DATANUM = args.datanum
    if args.num_epoch:
